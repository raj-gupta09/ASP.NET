<%@ Page Title="" Language="C#" MasterPageFile="~/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="InsertStudent.aspx.cs" Inherits="AspAddDemo.InsertStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <table style="width:100%">
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfvCode" runat="server" ControlToValidate="txtCode" 
                    ErrorMessage="Enter Student Code" ForeColor="Red">                </asp:RequiredFieldValidator>         
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="txtDCode" TextMode="Number" runat="server"></asp:TextBox>
             </td>
            <td>
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="btnSubmit" Text="Insert" runat="server" OnClick="btnSubmit_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
